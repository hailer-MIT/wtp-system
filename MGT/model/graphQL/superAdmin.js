...
module.exports.typeDef = `
    ...
    extend type Mutation {
        ...
        SuperAdminForgotPassword(phoneNumber: Int! otp: Int! password: String! confirmPassword: String! ): SuperAdmin!
        SuperAdminSendOtp(phoneNumber: Int!): Boolean! 
    }
`;
...
module.exports.resolvers = {
  ...
  Mutation: {
    async SuperAdminForgotPassword(_, args, ctx) {
    ...
    async SuperAdminSendOtp(_, args, ctx) {
      return await sendOtp(args, superAdmin);
    },
