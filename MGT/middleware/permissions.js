...
const permissions = shield(
  {
    Query: {
      ...
      InventoryGetAssets: or(
        isAuthenticatedAsAccountant,
        isAuthenticatedAsDesigner,
        isAuthenticatedAsInventoryClerk,
        isAuthenticatedAsReception,
        isAuthenticatedAsManager,
        isAuthenticatedAsSuperAdmin
      ),
      ...
      AllDesigners: or(isAuthenticatedAsReception, isAuthenticatedAsSuperAdmin),
      AllWorkshops: or(isAuthenticatedAsReception, isAuthenticatedAsSuperAdmin),
    ...
    Mutation: {
      ...
      SuperAdminForgotPassword: allow,
      SuperAdminSendOtp: allow,
      ...
      ChangeGoesToDesigner: or(
        isAuthenticatedAsSuperAdmin,
        isAuthenticatedAsReception
      ),
      ChangeGoesToWorkshop: or(
        isAuthenticatedAsSuperAdmin,
        isAuthenticatedAsReception
      ),
      OrderRemoveService: or(
        isAuthenticatedAsSuperAdmin,
        isAuthenticatedAsReception
      ),
      OrderAddService: or(
